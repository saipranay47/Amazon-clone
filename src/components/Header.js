    ...
    <header className="relative">
      ...
      <div className="bg-white w-80 absolute h-screen duration-100  z-50 overflow-x-hidden overflow-y-scroll " style={sidebaropen ? {"left":"0px"}:{"left":"-500px"}}>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <ul className="mt-6 border-b-2 border-gray-300">
            <p className="font-bold ml-6 text-lg">Digital Content and Devices</p>
      ...
      <div className="absolute overflow-hidden left-0 right-0 h-screen bg-black opacity-70 z-40" style={sidebaropen ? {visibility:"visible"}:{visibility:"hidden"}} onClick={handleClose}></div>
